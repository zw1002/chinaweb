           ...
           <div class="wid260px fl">
             <div class="grzl_box">
                 ...
                 <div class="mj_tab">
                    <table width="100%">
                       <tr>
                           <td width="50%"> <a href="#"><img src="<%=basePath%>/static/images/icon_mj.png" height="16" width="16" /> 成为卖家</a></td>
                       </tr>
                    </table>
                 </div>
             </div><!-- grzl_box --> 
                  ...
                  <div class="sc_boxd">
                     <table width="100%">
                       <tr>
                          <td>
                            <div class="sc_boxdd">
                                <div class="form-group" id="adjustDiv"></div>
                                <input id="recordFid" name="fid" type="hidden"/>
                                 <div class="sc_btn_big">选择源文件 <input id="file" name="file" type="file"></div>
                                 <p class="col_999">支持GIF、PNG、JPG等格式，体积在300MB以下</p>
                            </div>
                          </td>
