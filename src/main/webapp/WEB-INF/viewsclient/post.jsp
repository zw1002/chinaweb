        ...
        <div class="home_nav">
           <ul>
              ...
              <li><a class="" href="works.jsp">作品</a></li>
                      ...
                      <li><a class="active" href="post.jsp">帖子</a></li>
        ...
        <div class="wid920px fl">
             ...
             <div class="post_list">
                <ul>
                    <li>
                      <div class="titdd">
                         <h2>唯有中国风 <span>10天前</span></h2>
                         
                         <div class="pos_fr"><span class="ll_icon" style="margin-right:12px;">1500</span><span class="icon_hp">700</span></div>                      
                      </div>
                      
                      <div class="bq_boxff">
                        标签：<span class="bgd_bg">设计</span> <span class="bgd_bg">故事</span> <span class="bgd_bg">美图</span>
                        &nbsp; &nbsp; &nbsp; &nbsp; 分类：图示图片
                        &nbsp; &nbsp; &nbsp; &nbsp; 发布人：小资创意
                      </div>
               ...
               <div class="page_list clearfix">
                 ...
                 <a href="#"><img src="<%=basePath%>/static/images/sytk_pic8.png" /></a>
                  
                 </div>
                  <div class="imgdds">
                  <div class="btn_pos"><a href="#">收藏</a> <a href="#" class="buy_nowd">立即购买</a></div>
                 <a href="#"><img src="<%=basePath%>/static/images/sjtka_pic3.png" /></a>
                
                 </div>
                  <div class="imgdds">
                  <div class="btn_pos"><a href="#">收藏</a> <a href="#" class="buy_nowd">立即购买</a></div>
                 <a href="#"><img src="<%=basePath%>/static/images/sjtka_pic2.png" /></a>
                 </div>
                 ...
                 <a href="#"><img src="<%=basePath%>/static/images/sjtka_pic2.png" /></a>
                      ...
                      <div class="js_txtd">我是标题我是标题我是标题我是标题我是标题我是标题我是标题我是标题我是标题我是标题我是标题我是标题</div>
                    </li>
               ...
               <div class="page_list clearfix">
                 ...
                 <a href="#"><img src="<%=basePath%>/static/images/sjtka_pic2.png" /></a>
                      ...
                      <div class="js_txtd">我是标题我是标题我是标我是标题我是标题我是标题我是标题我是标题我是标题我是标题我是标题我是标题我是标题我是标题我是标题题我是标题我是标题我是标题我是标题我是标题我是标题我是标题我是标题我是标题</div>
                    </li>
