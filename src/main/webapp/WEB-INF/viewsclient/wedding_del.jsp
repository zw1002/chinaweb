       ...
       <div class="wid780px fl">
         ...
         <div class="gallery_video" >
				...
				<ul>
					...
					<li><img src="<%=basePath%>/static/images/sytk_pic8.png" /> <span class="bofang_icon"></span></li>
					<li><img src="<%=basePath%>/static/images/hlx_big.png" /> </li>
					<li><img src="<%=basePath%>/static/images/pbl_8.png" /> <span class="bofang_icon"></span></li>
                    <li><img src="<%=basePath%>/static/images/sytk_pic3.png" /> <span class="bofang_icon"></span></li> 
